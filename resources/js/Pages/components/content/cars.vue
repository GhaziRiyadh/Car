        ...
        <div class="w-full h-[60vh]">
            <div class="h-4/5 overflow-auto snap-y scroll-smooth span-center bg-gray-50 p-1">
                <div
                    ...
                    <span class="mx-auto w-1/6 whitespace-nowrap overflow-auto ">اسم الشركة: {{ item.company }}</span>
                    <span class="mx-auto w-1/6 whitespace-nowrap overflow-auto ">العام: {{ item.year }}</span>
                    <span class="mx-auto w-1/6 whitespace-nowrap overflow-auto ">اللون: {{ item.color }}</span>
