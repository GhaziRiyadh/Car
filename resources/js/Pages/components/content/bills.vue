        ...
        <MyForm :show="showForm.update">
            ...
            <template #model-content>
                <div class="my-2 text-xs">
                    ...
                    <div dir="rtl" class="w-full py-4 px-2 bg-gray-200 h-64 overflow-auto rounded-lg">
                        <div class="w-full p-2 bg-white shadow-lg flex" v-for="item in editData.products" :key="item.id">
                           <span class="mx-auto w-1/6 whitespace-nowrap overflow-auto flex items-center justify-around">
                                <span>الاسم:</span>
                                <span>{{ item.name }}</span>
                            </span>
            ...
            <template #model-footer>
                <div dir="rtl" class="w-full flex items-center justify-between">
                    <JetPrimaryButton v-show="showNextStatus"
                                      v-text="getNextStatus()"
                                      @click="changeStatus(editData.id, getNextStatus())"
                                      class="mx-5"
                    >
                    </JetPrimaryButton>
