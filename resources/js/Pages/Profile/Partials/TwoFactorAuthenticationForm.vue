...
<template>
    <JetActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-primary">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-primary">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-medium text-primary">
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    ...
                    <div class="mt-4 max-w-xl text-sm text-primary" v-if="setupKey">
